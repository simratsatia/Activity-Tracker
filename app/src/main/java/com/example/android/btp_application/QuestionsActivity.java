...
//        }
        ...
        rgEsteem = (RadioGroup) findViewById(R.id.rg11);
        rgEsteem.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {

                if(rgEsteem.getCheckedRadioButtonId()!=-1){
                    int id= rgEsteem.getCheckedRadioButtonId();
                    View radioButton = rgEsteem.findViewById(id);
                    int radioId = rgEsteem.indexOfChild(radioButton);
                    RadioButton btn = (RadioButton) rgEsteem.getChildAt(radioId);
                    String selection = (String) btn.getText();
